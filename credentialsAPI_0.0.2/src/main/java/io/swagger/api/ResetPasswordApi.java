...
public interface ResetPasswordApi {
    ...
    @ApiOperation(value = "ResetPassword", notes = "By tapping on the \"Reset\" button at the main page, an AJAX request is sent to this endpoint with secureToken. After eMail end bc with instrutions how to update password", response = Void.class, tags={ "reset", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> resetPasswordPost(@ApiParam(value = "" ,required=true ) @RequestHeader(value="securetoken", required=true) String securetoken);
