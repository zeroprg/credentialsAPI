...
@Api(value = "reset-validation-email", description = "the reset-password API")
public interface SendValidationEmailApi {

    @ApiOperation(value = "ResetValidationEmail", notes = "Initiate password reset flow initiated by user because user forgot password.  (eMail passed in header).It will send eMail validation  which will have link  to update password endpoint.",
    ...
    @RequestMapping(value = "/reset-validation-email",
