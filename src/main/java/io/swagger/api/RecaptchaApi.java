...
@Api(value = "recaptcha", description = "the recaptcha API")
public interface RecaptchaApi {

	   @ApiOperation(value = "Recaptcha", notes = "The same as /register end point except just do only Gogle recaptcha functionality: https://o7planning.org/en/10397/using-google-recaptcha-with-java-web-application", response = Object.class, tags={ "recaptcha", })
	    @ApiResponses(value = { 
	    ...
	    ResponseEntity<Object> registerPost(
